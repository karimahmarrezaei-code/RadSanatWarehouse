# -*- coding: utf-8 -*-
"""
update_autocomplete_v3.py - رفع قطعی F2 (نسخه ۳)
==================================================
...
اجرا (از پوشه F:\\warehouse_app — برنامه بسته باشد):
    py -X utf8 .\\update_autocomplete_v3.py
...
def update_core():
    ...
    log('   ✅ auto_complete.py نسخه ۳ — سینتکس: ' + ('سالم' if ok else '❌ ' + str(err)[:100]))
    return ok
...
def main():
    log('=== به‌روزرسانی auto-complete (نسخه ۳: F2 با QShortcut) ===')
